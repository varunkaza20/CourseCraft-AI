...
export default function TopBar() {
  ...
  const getPageTitle = () => {
    switch (location.pathname) {
      case '/dashboard/curriculum': return 'Curriculum generation';
      case '/dashboard/courses': return 'Course generation';
      case '/dashboard/outcomes': return 'Learning outcome mapping';
  ...
  return (
    <div className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 shrink-0">
      <div className="flex items-center gap-3">
        <button className="md:hidden p-1 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-md transition-colors">
